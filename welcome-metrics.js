const text = "Enter the name of a tor relay and click Search to continue.Enter 'tor network' to view entire network...              Enter'relay list' to view a list of tor relays.";
