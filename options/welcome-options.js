const text = "Search by letter of alphabet for a full list of options traded at the Chicargo Board of Exchange,then select a company to view current options chains...";
